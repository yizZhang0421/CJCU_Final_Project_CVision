...
def base_minimizer(model, data, functions, algo, max_evals, trials, s,
    ...
    if full_model_string is not None:
        ...
        model_str = get_hyperopt_model_string(model, data, functions, notebook_name, verbose, stack, s=s)
...
def best_ensemble(nb_ensemble_models, model, data, algo, max_evals,
                  trials, s, voting='hard', weights=None, nb_classes=None, functions=None):
...
def get_hyperopt_model_string(model, data, functions, notebook_name, verbose, stack, s):
    ...
    if notebook_name:
        ...
        #calling_script_file = 'D:/Desktop/examination_hyperas.py'
